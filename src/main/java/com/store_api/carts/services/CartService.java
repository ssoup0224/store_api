package com.store_api.carts.services;
...
import com.store_api.products.repositories.ProductRepository;
...
public class CartService {
    ...
    public CartItemDto.CartItemResponse addItemToCart(UUID cartId, Long productId) {
    ...
    public CartItemDto.CartItemResponse updateCartItem(UUID cartId, Long productId, Integer quantity) {
        var cart = cartRepository.getCartWithItems(cartId).orElse(null);
        if (cart == null) {
            throw new CartNotFoundException();
        }
